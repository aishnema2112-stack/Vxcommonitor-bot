...
def check_single_account(username):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Agar API successfully data return karti hai aur error nahi hai toh account active hai
...
if __name__ == "__main__":
    print("[INIT] Starting Bot with Stable RapidAPI Host...", flush=True)
